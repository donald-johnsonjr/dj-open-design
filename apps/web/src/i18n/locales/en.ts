...
export const en: Dict = {
  ...
  'settings.onboardingCloudTitle': 'Sign in to Kinected Design',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to Kinected Design',
  ...
  'pluginsView.catalogCount': '{count} in catalog',
  'pluginsView.mastheadTitleLead': 'A workbench for your',
  'pluginsView.mastheadTitleAccent': 'agent',
  ...
  'integrations.mastheadTitleLead': 'Integrations that reach',
  'integrations.mastheadTitleAccent': 'everywhere',
  ...
  'designs.mastheadEyebrow': 'Workspace',
  'designs.projectCount': '{count} projects',
  'designs.mastheadTitleLead': 'Every project keeps the',
  'designs.mastheadTitleAccent': 'why',
  'designs.mastheadSubtitle': 'Open a project to keep building, or start a fresh one — every artifact you make with your agent gathers here.',
  'designs.emptyTitleLead': 'Design something worth',
  'designs.emptyTitleAccent': 'keeping',
  'designs.emptyBody': 'Every prototype, deck, and brand kit you build with your agent lives here. Start from a blank canvas or a template.',
  ...
  'ds.mastheadTitleLead': 'One brand, every',
  'ds.mastheadTitleAccent': 'surface',
  'ds.mastheadSubtitle': 'A curated library of complete design systems. Pick a starting point, make it your default, or shape your own with the agent.',
  'ds.presetsCountLabel': '{count} presets',
  'ds.newSystem': 'New system',
  'ds.featuredEyebrow': 'House system',
  'ds.featuredActiveEyebrow': 'Starter · Active default',
  'ds.featuredBody': 'Technology in service of the why — the house system every new project inherits. Dark, editorial, one violet signal.',
  'ds.featuredTags': 'Web · Image · Video',
  'ds.density': 'Density',
  'ds.densityComfortable': 'Comfortable rows',
  'ds.densityCompact': 'Compact rows',
  'ds.backToIndex': 'All systems',
  'ds.keyboardHint': 'Press / to search · ↑ ↓ to browse · ↵ to open',
  'ds.sectionResults': 'Results',
  'ds.emptyMineTitle': 'Start with one brand',
  'ds.emptyMineAccent': 'system',
  'ds.browsePresets': 'Browse presets',
};
