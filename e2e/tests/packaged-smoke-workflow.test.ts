  ...
  it("rejects stale latest platform manifests from a previous beta version", async () => {
    ...
    try {
      ...
      await writeFile(
        ...
        artifacts: {
          dmg: {
            url: "https://releases.open-design.ai/betas/versions/1.2.3-beta.3.unsigned/Kinected Design Beta.dmg",
          },
        },
        channel: "beta",
        github: {
  ...
  it("rejects stale latest platform manifests from a previous same-version beta workflow run", async () => {
    ...
    try {
      ...
      await writeFile(
        ...
        artifacts: {
          dmg: {
            url: "https://releases.open-design.ai/betas/versions/1.2.3-beta.4.unsigned/Kinected Design Beta.dmg",
          },
        },
        channel: "beta",
        github: {
  ...
  return {
    ...
    platforms: {
      mac: {
        arch: "arm64",
        artifacts: {
          dmg: artifact("Kinected Design.dmg"),
          zip: artifact("Kinected Design-mac-arm64.zip"),
        },
        enabled: true,
        signed: true,
      },
      macIntel: {
        arch: "x64",
        artifacts: {
          dmg: artifact("Kinected Design Intel.dmg"),
          zip: artifact("Kinected Design-mac-x64.zip"),
        },
        enabled: true,
        signed: true,
      },
      win: {
        arch: "x64",
        artifacts: {
          installer: artifact("Kinected Design Setup.exe"),
        },
        enabled: true,
      },
    },
